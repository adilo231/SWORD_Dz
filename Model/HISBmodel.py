...
class HSIBmodel():
    def __init__(self, Graph, Seed_Set=None, opinion_set=None,seedsSize=0.05, baisAccepte=0.15, setptime=0.125, Probability=0.15, Tdet=0.125,k=0, method='none',verbose=False):
