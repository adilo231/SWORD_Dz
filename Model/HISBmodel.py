...
class HSIBmodel():
    def __init__(self, Graph, Seed_Set=None, opinion_set=None,seedsSize=0.05, baisAccepte=0.2, setptime=0.125, Probability=0.2, Tdet=0.125,k=0, method='none',blockPeriod=0,verbose=False):
