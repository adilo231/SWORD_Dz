...
if __name__ == '__main__':
    ...
    aux_0 = Simulator.runSimulation(g, NbrSim=NbrSim ,seedsSize=0.002, typeOfSim=typeOfSim,simName=f'sim{i}',verbose=True,method='None',k=k)
    ...
    Simulator.DisplyResults( l,resultType=typeOfSim,save=True)
